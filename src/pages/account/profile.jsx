...
const ProfilePage = () => {
    ...
    const fetchUserProfile = async (userId) => {
        setLoading(true);
        try {
            const response = await fetch(`https://sparlex-spa.up.railway.app/api/v1/admin/accounts/find-by-id/${userId}`, {
                method: 'GET',
                credentials: 'include',
                headers: {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`https://sparlex-spa.up.railway.app/api/v1/admin/accounts/update/${profileData.id}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleDelete = async () => {
        ...
        try {
            const response = await fetch(`https://sparlex-spa.up.railway.app/api/v1/admin/accounts/delete/${profileData.id}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleUploadAvatar = async () => {
        ...
        try {
            ...
            const res = await fetch(`https://sparlex-spa.up.railway.app/api/v1/admin/accounts/upload-avatar/${profileData.id}`, {
                method: 'POST',
                credentials: 'include',
                body: formData
            });
